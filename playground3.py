...
for i in range(1, n_simulations):
    ...
    # Randomly generate a rate between 50% to 100% every 20% to 40% of the simulations
    if np.random.randint(1, 101) <= (50 + np.random.randint(0, 51)):
        equity_counter *= (1 + np.random.uniform(0.5, 1))
